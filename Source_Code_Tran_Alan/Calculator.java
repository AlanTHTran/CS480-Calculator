...
public class Calculator{
    ...
    public static void main(String args[])
    {
        ...
        System.out.println("For this calculator, normal arithmetic functions can work, such as '*', '/', and '^'.");
        System.out.println("However, for more complex functions, they must be typed, such as 'sqrt', 'sin', and 'cot'.");
        do {
